package com.github.dumock.http.controller.aspect;

import com.alibaba.fastjson.JSON;
import com.github.dumock.http.controller.filter.LoggerHelper;
...
public class WebLoggerAspect {
    ...
    // 定义切点Pointcut
    @Pointcut("execution(* com.github.dumock.http.controller.web..*(..))")
    private void logger() {
    }
