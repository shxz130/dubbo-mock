								...
								<div class="row">
									<div class="col-xs-12">
										...
										<p></p>
											...
											<button class="btn btn-success" onclick="javascript:window.location.href='quote_system.ftl';">引入新系统</button>
															...
															<div class="hidden-md hidden-lg">
																<div class="inline pos-rel">
																	...
																	<ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
																		...
																		<li>
																			<button href="scene_group.html" class="tooltip-success" data-rel="tooltip" title="Edit">
																				<span class="green">
