package com.github.dumock.service.db.aspect;
...
@Configuration
@Order(-97)
public class DBServiceLoggerAspect {

    private static final Logger logger = LoggerFactory.getLogger(DBServiceLoggerAspect.class);

    // 定义切点Pointcut
    @Pointcut("execution(* com.github.dumock.service.db..*(..))")
    private void logger() {
    }
